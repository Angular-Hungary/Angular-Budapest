...
module.exports = "<a class=\"button {{ type === 'secondary'? 'button--secondary': 'button--large'}} button--{{contentClassName}} href='https://budacode.com/'\">\n    {{title}}\n</a>"
